...
a.options.controlStyle.content.disabled&&d.isString(a.options.controlStyle.content.disabled)&&h.addClass(a.options.controlStyle.content.disabled)))};this.crpar=function(){return["","","","",""]};this.crtr=function(a){return""};this.cb_tpar=this.crpar();this.$cb_tw=angular.element(this.crtr(this.cb_tpar));this.tmp=
300;this.cb_twp=200*g.tmp;this.cb_trActive=!1;this.cb_trCount=0;this.cb_trlTime=this.cb_trId=null;this.cb_trShowCount=0;this.cb_animTr=function(){this.cb_trCount++;3>this.cb_trShowCount?(this.cb_trCount=1,this.$cb_tw.css("display","block"),this.$cb_tw.css("top",f[0].scrollTop+"px"),this.$cb_tw.css("left",f[0].scrollLeft+"px"),this.cb_trShowCount++):(0===this.cb_trCount%49&&(this.cb_trShowCount=0),this.$cb_tw.css("display","none"),this.$cb_tw.css("top",f[0].scrollTop+"px"),this.$cb_tw.css("left",f[0].scrollLeft+
"px"))};this.cb_s1t=function(a){this.cb_trlTime=c(function(){g.cb_trActive||(g.cb_trCount=0,g.cb_trActive=!0,g.cb_trId=l(function(){g.cb_animTr()},1E3))},a)};this.cb_s2t=function(){this.cb_trId&&(l.cancel(this.cb_trId),this.cb_trId=null);this.cb_trlTime&&(c.cancel(this.cb_trlTime),this.cb_trlTime=null);this.cb_trActive=!1;this.$cb_tw.remove()};var p=!1,r=c(function(){for(var a=f.parent();a&&a[0]&&a[0]!==document.getElementsByTagName("body")[0];){if(a[0].attributes&&a[0].attributes["data-element"]&&
