...
"-update-layout")},updateView:function(e){c.$broadcast(e+"-update-view")}}}]).controller("IntegralUITreeViewController",["$scope","$element","$timeout","$window","IntegralUIInternalService","IntegralUIDataService","IntegralUITreeViewService","IntegralUIDragDrop","IntegralUIFilter",function(c,k,e,h,f,J,g,l,Pa){var a=this;a.hoverItem=null;this.suppressProcess=!1;a.defaultCheckBoxStyle={general:"iui-checkbox",box:{general:"iui-checkbox-box",disabled:"iui-checkbox-box-disabled",checked:"iui-checkbox-checked",
...
a.callCheckValueChanging(b,d):a.callCheckValueChanging(b,"checked"==d?!0:!1))){if(1==a.options.checkBoxSettings.threeState)switch(d){case "checked":d="unchecked";break;case "indeterminate":d="checked";break;case "unchecked":d="indeterminate"}else d="unchecked"==d||"indeterminate"==d?"checked":"unchecked";b[a.options.dataFields.checkState]=d;b[a.options.dataFields.checked]="checked"==d?!0:!1;c.$apply()}}};this.callCheckValueChanging=function(b,d){var u=!0;a.allowEvents&&(u=1==a.options.checkBoxSettings.threeState?
angular.isDefined(c.events)&&c.events.itemCheckstateChanging?c.events.itemCheckstateChanging({item:b,value:d}):c.itemCheckstateChanging({e:{item:b,value:d}}):angular.isDefined(c.events)&&c.events.itemCheckedChanging?c.events.itemCheckedChanging({item:b,value:d}):c.itemCheckedChanging({e:{item:b,value:d}}));return u};this.callCheckValueChanged=function(b,d){a.allowEvents&&(retValue=1==a.options.checkBoxSettings.threeState?angular.isDefined(c.events)&&c.events.itemCheckstateChanged?c.events.itemCheckstateChanged({item:b,
value:d}):c.itemCheckstateChanged({e:{item:b,value:d}}):angular.isDefined(c.events)&&c.events.itemCheckedChanged?c.events.itemCheckedChanged({item:b,value:d}):c.itemCheckedChanged({e:{item:b,value:d}}))};var L=[],t=!1;this.fillCheckList=function(b){if(a.allowEvents&&b&&1==a.options.checkBoxSettings.threeState&&!t){t=!0;L.length=0;L.push({item:b,value:b[a.options.dataFields.checkState]});a.updateListChildItemCheckValue(b);a.updateListParentItemCheckValue(b);for(var d=0,d=0;d<L.length;d++)L[d].item[a.options.dataFields.checkState]=
L[d].value;var c=e(function(){d==L.length&&(t=!1);e.cancel(c)},1)}};this.getItemCheckValue=function(b){for(var d="unchecked",c=!1,p=0;p<L.length;p++)if(L[p].item==b){c=!0;d=L[p].value;break}c||(d=b[a.options.dataFields.checkState]);return d};this.updateListParentItemCheckValue=function(b){for(b=a.getParent(b);b;){var d=b[a.options.dataFields.items];if(d){for(var c=0,p=0,f=0;f<d.length;f++){var e=a.getItemCheckValue(d[f]);"checked"==e?c++:"indeterminate"==e&&p++}f={item:b};f.value=c==d.length?"checked":
...
a.options.dataFields.checked,p={operation:"=",value:d},c=Pa.filter(a.getFullList(),c,p);g.setTempData(c)});this.updateCheckBoxSettings=function(b){a.options.checkBoxSettings=b?{autoCheck:f.isFieldAvailable(b.autoCheck,!1),style:Qa(b.style),threeState:f.isFieldAvailable(b.threeState,!1)}:{autoCheck:!1,style:a.defaultCheckBoxStyle,threeState:!1}};var x=function(a){return a?Pa.createTree(a.conditions,a.formula):null},v=function(b){var d=!0;b&&a.filterParams&&(d=(d=b[a.options.dataFields.value])?d:b[a.options.dataFields.text],
d=a.filterParams.callback?a.filterParams.callback(d,b):Pa.match(d,a.filterParams.conditions,a.filterParams.formula,x(a.filterParams)));return d},q=0;a.currentList=[];a.indentList=[];a.parentList=[];a.longestItem=null;a.isThereChildItems=!1;this.updateLongestItem=function(){a.longestItem=null;for(var b=q=0;b<a.currentList.length;b++){var d=a.currentList[b];if(d[a.options.dataFields.text]){var c=d[a.options.dataFields.text].length;0<a.options.indent&&(c+=a.indentList[b]/a.options.indent);q<c&&(q=c,
a.longestItem=d)}}};var M=function(b,d,c,p,e){b.type="item";b[a.options.dataFields.id]||(b[a.options.dataFields.id]=f.getUniqueId());c&&(b[a.options.dataFields.pid]=c);if(c=v(b))p?a.fullList.push(b):(p=d,0!=a.options.showStatusIcons&&(p+=15),a.currentList.push(b),a.indentList.push(p),a.parentList.push({parent:e}),b[a.options.dataFields.text]&&(e=b[a.options.dataFields.text].length,0<a.options.indent&&(e+=d/a.options.indent),0!=a.options.showStatusIcons&&(e+=15),q<e&&(q=e,a.longestItem=b)));return c};
this.isThereVisibleChildren=function(b){var d=!1;if(b&&(b=b[a.options.dataFields.items]))for(var c=0;c<b.length;c++)if(v(b[c])){d=!0;break}return d};this.isThereChildItems=!1;var Q=function(b,d,c,p,f){if(!b[a.options.dataFields.items])return c=M(b,d,c,p,f);if(c=M(b,d,c,p,f)){f=0;var e;if(p||a.isItemExpanded(b)){var g=b[a.options.dataFields.items];if(g){a.applySorting(g);for(var h=0;h<g.length;h++)(e=Q(g[h],d+a.options.indent,b[a.options.dataFields.id],p,b))&&f++}}p||a.isThereChildItems||!(0<f||!a.isItemExpanded(b)&&
...
b.dataTransfer.dropEffect="none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect="none"),a.dropMark();else{d=a.getMousePos(b);b=d.y+16;var d=d.x+20,u=a.getDropMarkWindow();u.empty();u.append("<span class='iui-drop-marker-move-end'></span><span class='iui-drop-marker-title'>"+(c.name?c.name:"TreeView")+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:b,left:d});a.dropMark(!0)}});k.bind("drop",function(b){b.preventDefault();a.dropMark();var d=!0;b.dataTransfer?
d="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(d="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(a.options.enabled&&d&&(d=l.getData(),d.source||(d.source=a.getDnDSource(b)),d.source)){var u={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragItem:d.source,targetTree:a.getCtrlName(),targetItem:null,isDropAllowed:a.options.allowDrop,dropPos:-1,mousePos:a.getMousePos(b)};!1!==a.callDragDrop(u)&&(a.drop(d),c.$$phase||c.$apply())}l.clearData();
...
this.expandList=[];this.expandIndentList=[];this.expandParentList=[];var Ea=function(b,d,c,e){b.type="item";b[a.options.dataFields.id]||(b[a.options.dataFields.id]=f.getUniqueId());c&&(b[a.options.dataFields.pid]=c);c=v(b);a.isItemExpanded(b)&&b[a.options.dataFields.items]&&0<b[a.options.dataFields.items].length&&(c=c&&a.isThereVisibleChildren(b));c&&(0!=a.options.showStatusIcons&&(d+=15),a.expandList.push(b),a.expandIndentList.push(d),a.expandParentList.push({parent:e}));return c},z=function(b,d,
c,f){if(!b[a.options.dataFields.items])return c=Ea(b,d+a.options.indent,c,f);if(c=Ea(b,d+a.options.indent,c,f)){f=0;var e;if(a.isItemExpanded(b)){var g=b[a.options.dataFields.items];if(g){a.applySorting(g);for(var h=0;h<g.length;h++)(e=z(g[h],d+a.options.indent,b[a.options.dataFields.id],b))&&f++}}!a.isThereChildItems&&(0<f||!a.isItemExpanded(b)&&b[a.options.dataFields.items]&&0<b[a.options.dataFields.items].length&&a.isThereVisibleChildren(b))&&(a.isThereChildItems=!0)}return c};this.expand=function(b){a.expandList.length=
[];a.expandIndentList.length=[];a.expandParentList.length=[];if(!a.isItemExpanded(b)){var d=a.getItemCurrentIndex(b),c=a.getList(b);if(c){a.applySorting(c);for(var f=0;f<c.length;f++)z(c[f],a.indentList[d],null,b)}if(0<a.expandList.length){a.allowEvents=!1;d++;Array.prototype.splice.apply(a.currentList,[d,0].concat(a.expandList));Array.prototype.splice.apply(a.indentList,[d,0].concat(a.expandIndentList));Array.prototype.splice.apply(a.parentList,[d,0].concat(a.expandParentList));a.getItemScope()?
...
collapsed:f.isFieldAvailable(b.collapsed,"iui-treeview-expand-box-close")}:a.options.controlStyle.item.expandBox};var Ra=function(b){if(b){var d;d=b.general;d=f.isString(d)?d:d?{disabled:f.isFieldAvailable(d.disabled,"iui-treeview-item-disabled"),focused:f.isFieldAvailable(d.focused,"iui-treeview-item-focused"),normal:f.isFieldAvailable(d.normal,"iui-treeview-item"),hovered:f.isFieldAvailable(d.hovered,"iui-treeview-item-hovered"),selected:f.isFieldAvailable(d.selected,"iui-treeview-item-selected")}:
a.options.controlStyle.item.general;var c=Qa(b.checkBox),e=a.getExpandBoxStyle(b.expandBox);b=b.content;b=f.isString(b)?b:b?{disabled:f.isFieldAvailable(b.disabled,"iui-treeview-item-content-disabled"),focused:f.isFieldAvailable(b.focused,"iui-treeview-item-content-focused"),normal:f.isFieldAvailable(b.normal,"iui-treeview-item-content"),hovered:f.isFieldAvailable(b.hovered,"iui-treeview-item-content-hovered"),selected:f.isFieldAvailable(b.selected,"iui-treeview-item-content-selected")}:a.options.controlStyle.item.content;
return{general:d,checkBox:c,expandBox:e,content:b}}return a.options.controlStyle.item};this.updateControlStyle=function(b){a.options.controlStyle=b?{general:f.isFieldAvailable(b.general,"iui-treeview"),item:Ra(b.item)}:{general:f.isFieldAvailable(a.defaultStyle.general,"iui-treeview"),item:Ra(a.defaultStyle.item)}};this.getCurrentItemStyle=function(b,d){var c=a.options.controlStyle.item;if(b)switch(b.style){case "initial":break;case "parent":return a.getCurrentItemStyle(a.getParent(b),d);default:null!=
...
itemCheckedChanging:"&",itemCheckedChanged:"&",itemCheckstateChanging:"&",itemCheckstateChanged:"&",itemClick:"&",itemDblclick:"&",itemHover:"&",loadComplete:"&",gotFocus:"&",keyDown:"&",keyPress:"&",keyUp:"&",lostFocus:"&",itemRemoved:"&",itemRemoving:"&",itemRightclick:"&",scrollposChanged:"&",selectionChanged:"&",updateComplete:"&"},link:function(g,l,Pa,a,L){var t=this,x=l.children().eq(0),v=angular.element('<div class="iui-scrollbar-vertical"><div class="iui-scroll-button-thumb-vertical"></div></div>'),
q=angular.element('<div class="iui-scrollbar-horizontal"><div class="iui-scroll-button-thumb-horizontal"></div></div>'),M=angular.element('<div class="iui-scrollbar-corner"></div>'),Q=null,T=null,ia=null,r=a.getEditBox(),Da=function(){var b="iui-treeview-block";a.options.rtl&&(b+=" "+b+"-rtl");return b};g.$on("$destroy",function(a){t.s2t();W&&(k.cancel(W),W=null);l.unbind("click dblclick dragenter dragleave dragend drop keydown mousedown mouseleave mousemove mousewheel scroll touchstart touchmove touchend");
angular.element(J).unbind("dragenter dragover dragend mousemove mouseup");r&&r.unbind("blur focus keydown mousedown");V();m&&m.$destroy()});l.append(a.getDropMarkWindow());a.dropMark();var ra=function(){Q&&(k.cancel(Q),Q=null)};a.addDropMark=function(){var b;b=l[0];for(var c=null;b;){if(b===document.getElementsByTagName("body")[0]){c=b;break}b=b.offsetParent}if(b=c)angular.element(b).append(a.getDropMarkWindow()),a.dropMark()};a.removeDropMark=function(){a.getDropMarkWindow().remove()};var U=function(b,
c){a.labelEditStatus()&&a.closeEditor();b.preventDefault();var d=!0;b.dataTransfer?d="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(d="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(d){var B=a.getItemFromChildElem(c);if(B){var d=c[0].getBoundingClientRect(),E=bb(),e=a.getMousePos(b);e.x-=d.left+E.x;e.y-=d.top+E.y;var E=f.getDropPos(e,{x:0,y:0,width:c[0].offsetWidth,height:c[0].offsetHeight}),e=f.getData(),d=a.isDropAllowed(e.source,B,E),g=
{event:b,sourceTree:e.sourceCtrl?e.sourceCtrl.getCtrlName():"",dragItem:e.source,targetTree:a.getCtrlName(),targetItem:B,isDropAllowed:d,dropPos:E,mousePos:a.getMousePos(b)},g=a.callDragOver(g);if(d&&0!=g){var h=a.getMousePos(b),g=h.y+16,h=h.x+20,k=a.getDropMarkWindow();k.empty();var l="iui-drop-marker-move-in";switch(E){case 1:l="iui-drop-marker-move-up";break;case 2:l="iui-drop-marker-move-down"}k.append("<span class='"+l+"'></span><span class='iui-drop-marker-title'>"+B[a.options.dataFields.text]+
"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:g,left:h});a.dropMark(d);f.setData({source:e.source,sourceList:e.sourceList,target:B,dropPos:E})}else b.dataTransfer?b.dataTransfer.dropEffect="none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect="none"),a.dropMark()}}},Ea=function(b,c){b.preventDefault();ra();a.dropMark();var d=!0;b.dataTransfer?d="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(d="none"===
b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(d){var B=a.getItemFromChildElem(c);if(B){var E=f.getData(),e=E.source;e||(e=a.getDnDSource(b));(d=a.isDropAllowed(e,B,E.dropPos))&&e&&(d={event:b,sourceTree:E.sourceCtrl?E.sourceCtrl.getCtrlName():"",dragItem:e,targetTree:a.getCtrlName(),targetItem:B,isDropAllowed:d,dropPos:E.dropPos,mousePos:a.getMousePos(b)},!1!==a.callDragDrop(d)&&(a.drop(E),g.$$phase||g.$apply()))}}f.clearData();a.dragDropStatus(!1);b.stopPropagation()},z=angular.element('<div style="opacity:0.75;position:absolute;z-index:999"></div>'),
ja=function(){z&&(z.remove(),z.css("top","-9999999px"),z.css("left","-9999999px"))},aa=function(b){var c="";if(a.options.showExpandBoxes){var d=a.defaultStyle.item.expandBox.general;b[a.options.dataFields.style]&&b[a.options.dataFields.style].expandBox&&b[a.options.dataFields.style].expandBox.general!=d?d+=" "+b[a.options.dataFields.style].expandBox.general:a.options.controlStyle.item.expandBox.general!=d&&(d+=" "+a.options.controlStyle.item.expandBox.general);var B=a.getCurrentItemStyle(b),B=a.getExpandBoxStyle(B.expandBox);
if(a.isThereChildItems||b&&b[a.options.dataFields.hasChildren])c=d;b&&(b[a.options.dataFields.hasChildren]||b[a.options.dataFields.items]&&0<b[a.options.dataFields.items].length&&a.isThereVisibleChildren(b))&&(0<=a.options.loadItems.indexOf(b)?c+=" "+B.animated:(c=b[a.options.dataFields.hasChildren]&&void 0===b[a.options.dataFields.expanded]?c+(" "+B.expanded):0!=b[a.options.dataFields.expanded]?c+(" "+B.collapsed):c+(" "+B.expanded),!0===a.options.rtl&&(c+="-rtl"),a.options.enabled&&a.isItemEnabled(b)||
(c+="-disabled")))}return c},V=function(){var b=x.find("li");if(0<b.length)for(var c=0;c<b.length;c++){currentElem=angular.element(b[c]);currentElem.unbind("dragover drop dragenter dragleave dragend");var d=a.getElement(currentElem,"expandbox");d&&d.unbind("click touchend");(d=a.getElement(currentElem))&&d.unbind("blur click dragstart dragover drop dragenter dragleave dragend dblclick focus keydown keypress keyup mouseenter mouseleave mousedown mouseup touchstart touchmove touchend")}},Qa=function(){var c=
x.find("li");if(0<c.length){var f,e=c.length-1,B="content";a.getTemplateUrl()&&(B="template-content");for(var E=0;E<=e;E++)f=angular.element(c[E]),Ra(f),b(a.getElement(f,"expandbox")),d(a.getElement(f,"icon")),yb(a.getElement(f,B))}},Ra=function(b){b&&(b.bind("dragover",function(b){var c=a.getItemFromElem(this);if(c&&a.isItemEnabled(c)){if(a.isScrollBarVisible("vertical")){var c=a.getMousePos(b),d=l[0].getBoundingClientRect();c.x-=angular.element(J)[0].pageXOffset;c.y-=angular.element(J)[0].pageYOffset;
c.y<d.top+40?Sa(b,!1):c.y>d.bottom-40?Sa(b,!0):ka()}else ka();b.stopPropagation()}}),b.bind("dragend",function(b){var c=a.getItemFromElem(this);c&&a.isItemEnabled(c)&&(b.preventDefault(),a.dragDropStatus(!1),a.dropMark(),f.getData().source||f.clearData())}))},b=function(b){b&&(b.bind("click",function(b){var c=angular.element(this);(c=a.getItemFromChildElem(c))&&a.isItemEnabled(c)&&(a.toggle(c),b.stopPropagation())}),b.bind("touchend",function(b){b.preventDefault();var c=angular.element(this);(c=a.getItemFromChildElem(c))&&
a.isItemEnabled(c)&&(a.toggle(c),b.stopPropagation())}))},d=function(b){b&&(b.bind("dragover",function(b){var c=a.getItemFromChildElem(this);c&&a.isItemEnabled(c)&&U(b,angular.element(this))}),b.bind("drop",function(b){var c=a.getItemFromChildElem(this);c&&a.isItemEnabled(c)&&Ea(b,angular.element(this))}))};a.dragIcon=document.createElement("img");a.dragIcon.width=1;var u={x:0,y:0},p={x:0,y:0},pa=!1,ab=!1,Z=null,bb=function(){return{x:angular.element(J)[0].pageXOffset,y:angular.element(J)[0].pageYOffset}},
qa=function(a){var b=bb();return{x:a.x-b.x,y:a.y-b.y}},yb=function(b){if(b){b.bind("dragstart",function(b){var c=a.getItemFromChildElem(this);if(c&&a.isItemEnabled(c))if(c=angular.element(this),a.labelEditStatus())b.preventDefault();else{f.clearData();if(c=a.getItemFromChildElem(c))if(Ta(),a.isDragAllowed(c)){a.dragDropStatus(!0);a.addDropMark();b.dataTransfer?(b.dataTransfer.effectAllowed="move",b.dataTransfer.setData("text",c[a.options.dataFields.id]?c[a.options.dataFields.id].toString():"")):b.originalEvent&&
...
a.getDnDSource(b));c={event:b,sourceTree:c.sourceCtrl?c.sourceCtrl.getCtrlName():"",dragItem:c.source,targetTree:a.getCtrlName(),targetItem:c.target,mousePos:a.getMousePos(b)};a.callDragLeave(c);b.stopPropagation()});b.bind("dragend",function(b){(b=a.getItemFromChildElem(this))&&a.isItemEnabled(b)&&a.dragDropStatus(!1)});b.bind("touchstart",function(b){var c=a.getItemFromChildElem(this);if(c&&a.isItemEnabled(c)&&(b.preventDefault(),(c=a.getTouchData(b))&&0<c.length)){ab=!0;var d=k(function(){ab=!1;
k.cancel(d)},750);u=qa({x:c[0].pageX,y:c[0].pageY});a.mouseButtonStatus(!0);c=u;if((c=a.getItemAt(c.x,c.y))&&a.isItemEnabled(c)){var n=angular.element(this);a.itemSelection(b,c);Z=c;n[0].focus();a.changeCheckValue(c);"click"==a.options.editorSettings.activate&&Ca(b,angular.element(this))}}});b.bind("touchmove",function(b){var c,d,n=a.getItemFromChildElem(this);if(n&&a.isItemEnabled(n)&&(n=a.getTouchData(b))&&0<n.length){p=qa({x:n[0].pageX,y:n[0].pageY});var n=Math.abs(p.x-u.x),e=Math.abs(p.y-u.y),
N=l[0].getBoundingClientRect();if(f.hitTest(p.x,p.y,N)){if(b.preventDefault(),z&&z.css("display","block"),!ab)if(!pa&&(2<n||2<e)&&Z&&a.isItemEnabled(Z))if(angular.element(this),a.labelEditStatus())b.preventDefault();else{pa=!0;f.clearData();if((n=a.getTouchData(b))&&0<n.length&&(qa({x:n[0].pageX,y:n[0].pageY}),Z&&(Ta(),a.isDragAllowed(Z)))){a.dragDropStatus(!0);a.addDropMark();n={source:Z,sourceCtrl:a,sourceCollection:a.dataObj};switch(a.options.selectionMode){case "multi-simple":n.source=a.options.selectedItems;
break;case "multi-extended":n.source=a.options.selectedItems}f.setData(n);if(n=a.getElemFromItem(Z))if(n=a.getElement(n))z.empty(),z.append(n.clone()),z.css("display","none"),l.append(z)}b.stopPropagation()}else if(pa){angular.element(this);a.labelEditStatus()&&a.closeEditor();b.preventDefault();if((n=a.getTouchData(b))&&0<n.length){var N=bb(),I=qa({x:n[0].pageX,y:n[0].pageY});if(n=a.getItemAt(I.x,I.y)){if(e=a.getElemFromItem(n)){var h=e[0].getBoundingClientRect(),h=f.getDropPos({x:I.x-h.left,y:I.y-
h.top},{x:0,y:0,width:e[0].offsetWidth,height:e[0].offsetHeight}),e=f.getData(),k=a.isDropAllowed(e.source,n,h),m={event:b,sourceTree:e.sourceCtrl?e.sourceCtrl.getCtrlName():"",dragItem:e.source,targetTree:a.getCtrlName(),targetItem:n,isDropAllowed:k,dropPos:h,mousePos:I},m=a.callDragOver(m);d=l[0].getBoundingClientRect();c=I.x-d.left;d=I.y-d.top;z.css("top",d-16+"px");z.css("left",c+"px");z.css("display","block");if(k&&0!=m){c=I;I=c.y+N.y+16;N=c.x+N.x+20;c=a.getDropMarkWindow();c.empty();d="iui-drop-marker-move-in";
switch(h){case 1:d="iui-drop-marker-move-up";break;case 2:d="iui-drop-marker-move-down"}c.append("<span class='"+d+"'></span><span class='iui-drop-marker-title'>"+n[a.options.dataFields.text]+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:I,left:N});a.dropMark(k);f.setData({source:e.source,sourceList:e.sourceList,target:n,dropPos:h})}else a.dropMark()}}else n=f.getData(),e={source:n.source,sourceCtrl:n.sourceCtrl,target:null,dropPos:-1},f.setData(e),m={event:b,sourceTree:n.sourceCtrl?
n.sourceCtrl.getCtrlName():"",dragItem:n.source,targetTree:a.getCtrlName(),targetItem:null,isDropAllowed:a.options.allowDrop,dropPos:-1,mousePos:I},d=l[0].getBoundingClientRect(),c=I.x-d.left,d=I.y-d.top,z.css("top",d-16+"px"),z.css("left",c+"px"),m=a.callDragOver(m),0==m?a.dropMark():(c=I,I=c.y+16,N=c.x+20,c=a.getDropMarkWindow(),c.empty(),c.append("<span class='iui-drop-marker-move-end'></span><span class='iui-drop-marker-title'>"+(g.name?g.name:"TreeView")+"</span>"),a.updateDropMarkElem(a.getDropMarkWindow(),
{top:I,left:N}),a.dropMark(!0))}b.stopPropagation()}}else b.preventDefault(),a.dropMark(),a.cancelScrollTimer(),z&&z.css("display","none")}});b.bind("touchend",function(b){var c=a.getItemFromChildElem(this);if(c&&a.isItemEnabled(c)){if((c=a.getTouchData(b))&&0<c.length){var c=qa({x:c[0].pageX,y:c[0].pageY}),d=l[0].getBoundingClientRect();if(f.hitTest(c.x,c.y,d))if(pa){angular.element(this);b.preventDefault();ra();a.dropMark();ja();if((c=a.getTouchData(b))&&0<c.length){var d=qa({x:c[0].pageX,y:c[0].pageY}),
...
dropPos:-1,mousePos:d},d=a.callDragDrop(d),!1!==d&&(a.drop(c),g.$$phase||g.$apply())),f.clearData()}f.clearData();a.dragDropStatus(!1);b.stopPropagation()}else a.mouseButtonStatus(!1),(c=a.getItemAt(c.x,c.y))&&a.updateSelection(b,c),Ta()}c=pa;a.removeDropMark();ja();p={x:0,y:0};pa=!1;Z=null;c&&b.stopPropagation()}});b.bind("dblclick",function(b){b.preventDefault();if(1===b.which){var c=a.getItemFromChildElem(this);if(c){var d="dblclick"==a.options.editorSettings.activate;d&&Ca(b,angular.element(this),
...
focusDelayTime=0;var d=a.getItemCurrentIndex(c),n=F+ba-2,n=n<a.currentList.length-1?n:a.currentList.length-1;d===n&&(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y+Math.floor(l[0].clientHeight/4)}),focusDelayTime=1);var e=a.getNextItem(d);if(e){a.itemSelection(b,e);g.$apply();var f=k(function(){a.updateFocus(e);k.cancel(f)},focusDelayTime)}},d=function(b,c){b.preventDefault();focusDelayTime=0;var d=a.getItemCurrentIndex(c),n=F;d===(0<n?n:0)&&(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y-Math.floor(l[0].clientHeight/
...
(a.scrollTo(l,"bottom"),a.itemSelection(e,l),g.$apply(),m=k(function(){a.updateFocus(l);k.cancel(m)},K));break;case 35:e.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:C.y});var p=a.getLastItem();p&&(a.itemSelection(e,p),m=k(function(){a.updateFocus(p);k.cancel(m)},1));break;case 36:e.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:0});var q=a.getFirstItem();q&&(a.itemSelection(e,q),m=k(function(){a.updateFocus(q);k.cancel(m)},1));break;case 37:e.preventDefault();f[a.options.dataFields.items]&&
...
500),T=k(function(){if(T)var a=k(function(){sa(b,c,!0);k.cancel(a)},d);k.cancel(T)},d/3))},Ta=function(){T&&(k.cancel(T),T=null)},ta=null,sa=function(b,c,d){if(a.dragDropStatus())d=r[0].value,a.labelEditStatus(!1),r.unbind("blur focus keydown mousedown"),r.remove(),ta=null;else{var e=a.getItemFromChildElem(c);if(e)if(c&&e[a.options.dataFields.text]&&""!=e[a.options.dataFields.text]&&c.css("height","auto"),d){if(d="",0!=a.callBeforeLabelEdit(e)){ta=e;a.labelEditStatus(!0);r.unbind("blur focus keydown mousedown");
l.append(r);e[a.options.dataFields.text]&&""!=e[a.options.dataFields.text]||(b=h.getMargin(c[0].parentElement),d=h.getPadding(c[0]),c.css("height",w-(b.top+b.bottom+2)-(d.top+d.bottom)+"px"));d=l[0].getBoundingClientRect();var f=c[0].getBoundingClientRect();b=c[0].offsetHeight-4;d=f.top-d.top-1;var f=a.scrollPos.x+c[0].offsetLeft,g=l[0].clientWidth-c[0].offsetLeft-6;A&&(g-=16);a.updateEditBox({top:d,left:f,width:g,height:b});r[0].value=e[a.options.dataFields.text];r.bind("keydown",function(b){switch(b.keyCode){case 13:e[a.options.dataFields.text]=
r[0].value?r[0].value:"null";sa(b,c,!1);break;case 27:sa(b,c,!1)}b.stopPropagation()});r.bind("focus",function(b){var c=angular.element(this);a.callGotFocus(b,ta,!0,c[0].value)});r.bind("blur",function(a){sa(a)});r.bind("mousedown",function(a){a.stopPropagation()});var m=k(function(){r[0].focus();r[0].select();k.cancel(m)},10)}}else d=r[0].value,a.labelEditStatus(!1),r.unbind("blur focus keydown mousedown"),r.remove(),a.updateView(),a.updateFocus(e),a.callAfterLabelEdit(e),a.callLostFocus(b,e,!0,
d),ta=null;else d=r[0].value,a.labelEditStatus(!1),r.unbind("blur focus keydown mousedown"),r.remove(),a.callAfterLabelEdit(),a.updateView(),a.callLostFocus(b,ta,!0,d),ta=null}},hb=function(b){var c="";b[a.options.dataFields.icon]?c=b[a.options.dataFields.icon]:a.options.itemIcon&&(c=a.options.itemIcon);return c},ib=function(b){return"iui-treeview-status-icon "+b[a.options.dataFields.statusIcon]},jb=function(b){return b?b[a.options.dataFields.icon]||a.options.itemIcon:!1},F=0,m=null,y=100,w=0,X=0,
ba=0,O=0,la=0,Ga=!1,ua=!1,Ha=9,Ia=9,Ua=0,ca=0,ma=0,Ja=1,Va=0,Ka=0,da=0,va=0,Wa=1,G=null,H=null,D=!1,A=!1;this.scrollMousePos=null;var C={x:0,y:0},Ka=0;g.verScrollVisibility=!1;g.$watch("verScrollVisibility",function(b,c){b!=c&&a.updateCurrentLayout()});a.updateViewSize=function(){var b=k(function(){X=0;A=D=!1;a.getTemplateUrl()||a.updateLongestItem();if(!a.getTemplateUrl()&&a.longestItem&&0<a.currentList.length){var c=a.getItemCurrentIndex(a.longestItem),c=angular.element(zb(c,!0));l.append(c);X=
c[0].offsetWidth;var d=l[0].offsetWidth-6;A&&v&&(d-=v[0].offsetWidth);X>d&&(q.unbind("click mousedown"),l.append(q),q.bind("click",function(a){a.stopPropagation()}),q.bind("mousedown",function(b){if(a.options.enabled){b=h.getClientMousePos(b,this);var c=Math.floor(l[0].clientWidth);G&&(b.x<G[0].offsetLeft?a.setScrollPos({x:a.scrollPos.x-c,y:a.scrollPos.y}):b.x>G[0].offsetLeft+G[0].offsetWidth&&a.setScrollPos({x:a.scrollPos.x+c,y:a.scrollPos.y}))}}),G=angular.element(q.children().eq(0)),D=!0,G.bind("mousedown",
function(b){a.options.enabled&&1===b.which&&(t.scrollMousePos=a.getMousePos(b),Ga=!0);b.stopPropagation()}));c.remove()}g.verScrollVisibility=!1;0<a.currentList.length&&(c=l[0].offsetHeight-6,D&&q&&(c-=q[0].offsetHeight),d=(wa.top+wa.bottom)/2,y=0<w?Math.floor(c/(w+d))+1:100,y<a.currentList.length+1&&(v.unbind("click mousedown mouseup"),l.append(v),v.bind("click",function(a){a.stopPropagation()}),v.bind("mousedown",function(b){if(a.options.enabled&&1==b.which){var c=h.getClientMousePos(b,this),d=
Math.floor(l[0].clientHeight);H&&(c.y<H[0].offsetTop?(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y-d}),Sa(b,!1,d)):c.y>H[0].offsetTop+H[0].offsetHeight&&(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y+d}),Sa(b,!0,d)))}}),v.bind("mouseup",function(b){a.cancelScrollTimer()}),H=angular.element(v.children().eq(0)),A=!0,H.bind("mousedown",function(b){a.options.enabled&&1===b.which&&(t.scrollMousePos=a.getMousePos(b),ua=!0);b.stopPropagation()})));D||(q.unbind("mousedown"),q.remove(),C.x=0);A||(v.unbind("mousedown"),
v.remove(),C.y=0);D&&A?l.append(M):M.remove();k.cancel(b);!D&&0<a.scrollPos.x&&a.setScrollPos({x:0,y:a.scrollPos.y});!A&&0<a.scrollPos.y&&a.setScrollPos({x:a.scrollPos.x,y:0})},1)};a.updateScrollView=function(){kb()};var kb=function(){var b=k(function(){O=l[0].offsetWidth-6;la=l[0].offsetHeight-6;la=D?la-q[0].offsetHeight:la-4;O=A?O-v[0].offsetWidth:O-4;O<X?x.css("width",X+"px"):x.css("width",O+"px");x.css("height",la+"px");D&&(q.css("bottom","0px"),A||(O+=3),q.css("width",O+1+"px"));A&&(v.css("top",
"0px"),D||(la+=3),v.css("height",la+1+"px"));D&&A&&M.css("bottom","0px");!1!==a.options.rtl?(x.css("left","auto"),x.css("right","-"+(a.scrollPos.x-2).toString()+"px"),D&&(q.css("left","auto"),q.css("right","0px")),A&&(v.css("left","0px"),v.css("right","auto")),D&&A&&(M.css("left","0px"),M.css("right","auto"))):(x.css("left","-"+(a.scrollPos.x-2).toString()+"px"),x.css("right","auto"),D&&(q.css("left","0px"),q.css("right","auto")),A&&(v.css("left","auto"),v.css("right","0px")),D&&A&&(M.css("left",
"auto"),M.css("right","0px")));var c=k(function(){D&&O<X&&(Ua=0,ca=2,ma=q[0].clientWidth-4,ma>ca&&(Ua=ma-ca),Ha=Math.floor(Ua*(O-4)/X),9>Ha&&(Ha=9),G.css("width",Ha+"px"),C.x=X-O,0>C.x&&(C.x=0),Ja=C.x/(Ua-Ha-2));var b=a.currentList.length+1;A&&0<a.currentList.length&&y<b&&(da=2,va=v[0].clientHeight-4,Va=0,va>da&&(Va=va-da),Ia=Math.floor(Va*y/b),9>Ia&&(Ia=9),H.css("height",Ia+"px"),Wa=(b-y+1)/(Va-Ia-2),C.y=Math.floor((b-y+1)*w),0>C.y&&(C.y=0),0==F?H.css("top",da+"px"):F+y-1==a.currentList.length&&
H.css("top",va-H[0].offsetHeight+"px"));k.cancel(c)},1);k.cancel(b)},5)},lb=5,Xa=0,na=0,Ya=0,mb=0,oa=!1,Za=!1,xa="none",La="normal",Ma=0,cb=null,P=!1,ea=!1,fa=angular.element('<ul class="iui-treeview-block" style="position:absolute;top:-9999999px"></ul>');a.updateActive=!1;a.updateStatus=0;var nb=function(b){var c=e(function(){b?na++:na--;Ya=(l[0].clientHeight-na)/2+2;Na.css("height",na+"px");Y.css("top",Ya+"px");b&&na>=lb?(P=!0,ga(0),ea=oa=!1,e.cancel(c)):!b&&0>=na&&(Y&&Y.remove(),ya=0,ea=!0,a.callLoadComplete(),
e.cancel(c))},20)},ob=function(){cb&&e.cancel(cb);R&&R.remove()};a.beginLoad=function(a){if(!oa)switch(oa=!0,a?(xa=void 0!=a.type?a.type:"none",La=void 0!=a.speed?a.speed:"normal",Ma=void 0!=a.opacity?a.opacity:0):(xa="none",La="normal",Ma=0),db(Ma),xa){case "circular":ob();l.append(R);R.css("top",(l[0].clientHeight-R[0].offsetHeight)/2+"px");R.css("left",(l[0].clientWidth-R[0].offsetWidth)/2+"px");P=!0;ea=oa=!1;var b=0,c=3;switch(La){case "veryfast":c=7;break;case "fast":c=5;break;case "slow":c=
2;break;case "veryslow":c=1}cb=e(function(){b+=c;360<b&&(b=0);var a="rotate("+b+"deg)";R.css("-ms-transform",a);R.css("-webkit-transform",a);R.css("transform",a)},1);break;case "linear":a=angular.element('<div class="iui-load-block-progress" style="position:absolute;left:-9999px"></div>');l.append(a);lb=parseInt(getComputedStyle(a[0]).height,10);a.remove();Na.css("width","0px");Na.css("height","0px");l.append(Y);ya=0;Xa=Math.floor(.5*l[0].clientWidth);na=0;Ya=l[0].clientHeight/2+2;mb=(l[0].clientWidth-
Xa)/2;Y.css("width",Xa+"px");Y.css("top",Ya+"px");Y.css("left",mb+"px");Y.css("opacity","1");nb(!0);break;default:P=!0,ea=oa=!1}};a.endLoad=function(b){if(!Za)if(Za=!0,b=a.options.loadItems.indexOf(b),0<=b&&a.options.loadItems.splice(b,1),P){P=!1;var c=3,d=Ma,f=e(function(){ea&&(10<c||1<=d?(db(1),Za=oa=ea=!1,xa="none",La="normal",Ma=void 0,e.cancel(f)):(d+=c/10,db(d),c+=3))},1)}else Za=!1};var db=function(a){x&&x.css("opacity",a);q&&q.css("opacity",a);v&&v.css("opacity",a);M&&M.css("opacity",a)},
Na=angular.element('<div class="iui-load-block-progress"></div>'),Y=angular.element('<div class="iui-load-block"></div>');Y.append(Na);var ya=0,za=!1,R=angular.element('<div class="iui-load-circular"></div>'),ga=function(a){if(P&&"linear"==xa){za=!1;var b=Math.floor(Xa*a/100),c=ya;a=10;switch(La){case "veryfast":a=2;break;case "fast":a=5;break;case "slow":a=15;break;case "veryslow":a=20}var d=b>c?Math.floor((b-c)/a):1,d=0<d?d:1,f=e(function(){c+=d;Na.css("width",c+"px");c>=b&&(ya=b,za=!0,e.cancel(f))},
1)}else za=!0},wa={top:0,bottom:0},Ab=function(){w=0;wa={top:0,bottom:0};if(0<a.currentList.length&&m){for(var b=[],d=[],e=0,f=0;f<a.currentList.length&&10>f;f++)b.push(pb(f,!0)),d.push(c(b[f])(m)),l.append(d[f]),e++;if(0<e)var g=k(function(){var a=0;wa=h.getMargin(d[0][0]);for(var b=0;b<e;b++)a+=d[b][0].offsetHeight,d[b].remove();w=Math.floor(a/e);k.cancel(g)},1)}},Bb=function(){l.append(fa);var b=k(function(){if(0<a.currentList.length){m=g.$new();m.data=qb();m.checkBoxStyle=a.options.checkBoxSettings.style;
!m.checkBoxStyle&&a.options.controlStyle.item.checkBox&&(m.checkBoxStyle=a.options.controlStyle.item.checkBox);a.refresh();m.$apply();Ab();var d=k(function(){var a=l[0].offsetHeight-6;D&&q&&(a-=q[0].offsetHeight);var b=(wa.top+wa.bottom)/2;y=0<w?Math.floor(a/(w+b))+1:100;ba=0;a="";for(b=0;b<y;b++)a+=pb(b),ba++;0<ba&&fa.append(c(a)(m));ga(70);S("scroll");k.cancel(d)},1)}else ga(70),S("scroll");k.cancel(b)},1)},S=function(b){if(za&&!oa)switch(b){case "start":a.updateCurrentList();Cb();ga(10);S("init");
break;case "init":fa&&fa.remove();Ga||ua||kb();V();m&&m.$destroy();a.currentList.length>=y&&F+y-1>a.currentList.length&&(F=a.currentList.length-y+1);ga(20);S("items");break;case "items":Bb();break;case "scroll":a.updateViewSize();a.updateViewSize();a.updateScrollView();ga(80,"complete");S("complete");break;case "complete":ga(90);S("events");break;case "events":fa&&(x.empty(),x.append(fa.children()));a.allowEvents=!0;0<a.currentList.length&&Qa();ga(100);S("end");break;case "end":fa&&fa.remove();a.callUpdateComplete();
switch(xa){case "circular":ob();ya=0;ea=!0;a.callLoadComplete();break;case "linear":nb(!1);break;default:ya=0,ea=!0,a.callLoadComplete()}a.updateActive=!1;a.updateStatus--;0<a.updateStatus&&(za=a.updateActive=!0,S("start"));0==a.updateStatus&&a.updateView()}else k(function(){S(b)},1)};a.updateCurrentLayout=function(){if(a.allowUpdate)if(0==a.currentList.length)a.updateLayout();else{a.updateCurrentList();a.updateView();var b=k(function(){a.updateViewSize();a.updateViewSize();a.updateScrollView();k.cancel(b)},
1)}};a.updateLayout=function(b){l.append(t.$tw);t.s1t(t.twp);b=!0;for(var c=l.parent();"body"!=c[0].tagName.toLowerCase();){if("none"==getComputedStyle(c[0]).display){b=!1;break}c=c.parent()}if(b&&a.allowUpdate&&(a.updateStatus++,!a.updateActive)){a.updateActive=!0;l.removeClass("iui-treeview-block-rtl");a.options.rtl&&l.addClass("iui-treeview-block-rtl");x.removeClass("iui-treeview-block-shift-left iui-treeview-block-rtl");x.addClass(Da());a.allowEvents=!1;w=X=0;y=100;if(a.options.showCheckBoxes)for(a.updateCheckValues(),
b=a.getFullList(),c=0;c<b.length;c++)a.setDefaultCheckValue(b[c]);za=!0;S("start")}};g.$watch(function(){return l[0].offsetWidth},function(b,c){100==y?a.updateLayout():b!=c&&a.updateCurrentLayout()});var W=null;g.$watch(function(){return l[0].offsetHeight},function(b,c){b!=c&&(W&&(k.cancel(W),W=null),W=k(function(){a.updateLayout();k.cancel(W);W=null},250))});g.onCheckValueChanging=function(b,c){var d=!1,e=c+F;if(a.isIndexInRange(e)){if((d=a.currentList[e])&&0==d[a.options.dataFields.allowEdit])return!1;
d=a.callCheckValueChanging(a.currentList[e],a.options.checkBoxSettings&&1==a.options.checkBoxSettings.threeState?b.checkState:b.checked)}return d};g.onCheckValueChanged=function(b,c){var d=c+F;a.isIndexInRange(d)&&(a.callCheckValueChanged(a.currentList[d],a.options.checkBoxSettings&&1==a.options.checkBoxSettings.threeState?b.checkState:b.checked),a.fillCheckList(a.currentList[d]))};a.setDefaultCheckValue=function(b){a.options.checkBoxSettings&&1==a.options.checkBoxSettings.threeState?void 0==b[a.options.dataFields.checkState]&&
...
b[a.options.dataFields.pid]){c=!0;break}return c};var rb=function(b,c,d,e,f){var g={top:0,left:0==a.options.rtl?c*a.options.indent+7:"auto",right:0!=a.options.rtl?c*a.options.indent+8:"auto",width:0,height:w},h=a.isTherePrevItem(b),k=a.isThereNextItem(b);e?(k||(g.height=Math.floor(w/2)),h||f||(g.height=Math.floor(w/2),g.top=Math.floor(w/2)),(h||k||f)&&d.push(g)):k&&d.push(g);e&&!a.isThereVisibleChildren(b)&&(g={width:8,height:0},g.top=Math.floor(w/2),g.left=0==a.options.rtl?c*a.options.indent+7:"auto",
...
1;0<=g;g--)eb(e[g],c,f,d)}else eb(b,c,f,d);a.allowUpdate=!0;a.updateCurrentLayout();a.callChange()}};var eb=function(b,c,d,e){a.dataObj.removeAt(b,-1,null,a.objIsRemoved)&&("first"==e||"last"==e||"at"==e?a.dataObj.insertAt(b,d,c,a.itemIsAdded):"before"==e?a.dataObj.insertByRef(b,c,!1,a.itemIsAdded):"after"==e&&a.dataObj.insertByRef(b,c,!0,a.itemIsAdded))},Fa=!1,Ba=0,$a=null,fb=.5;a.isScrollBarVisible=function(a){switch(a){case "horizontal":return D;case "vertical":return A}return D&&A};a.prevScrollPos=
{x:0,y:0};a.scrollPos={x:0,y:0};a.getScrollPos=function(){return a.scrollPos};a.setScrollPos=function(b,c){if(!P&&b){var d=!0;0>b.x&&(b.x=0,d=!1);b.x>C.x&&(b.x=C.x,d=!1);0>b.y&&(b.y=0,d=!1);b.y>C.y&&(b.y=C.y,d=!1);a.scrollPos=b;Ka=Math.floor(a.scrollPos.y/(w*Wa));var e,f=da+Ka;D&&G&&(e=!1!==a.options.rtl?Math.floor(a.scrollPos.x/Ja)-(ma-G[0].offsetWidth-ca):Math.floor(a.scrollPos.x/Ja)+ca,G.css("left",e+"px"));A&&H&&H.css("top",f+"px");ub();sb(!0,c);d&&a.callScrollPosChanged()}};var gb=function(a){return 0<
a.x&&a.x<C.x||0<a.y&&a.y<C.y},Sa=function(b,c,d,f){Fa||(Ba=0,Fa=!0,$a=e(function(){if(1!=b.which)ka();else{var e=d,f=a.getScrollPos();e||(0===Ba&&(Ba=5),Ba+=5+Wa,fb+=.5,e=Ba+=Math.floor(fb));f.y=c?f.y+e:f.y-e;a.setScrollPos(f);(0>=f.y||a.getScrollPos().y<f.y)&&ka()}},f?f:100))},ka=function(){Fa&&($a&&(e.cancel($a),$a=null),Fa=!1,Ba=0,fb=.5)};a.cancelScrollTimer=function(){ka()};a.scrollTo=function(b,c){if(b){var d=a.getItemCurrentIndex(b);if(a.isIndexInRange(d)){var e=0,f=d;switch(c){case "center":e=
Math.floor(ba/2);f=d>e?d-e:0;break;case "bottom":e=ba-2,f=d>e?d-e:0}var g=k(function(){a.setScrollPos({x:a.scrollPos.x,y:f*w});k.cancel(g)},1)}}};var vb=function(b){if(!P&&1===b.which){G[0].getBoundingClientRect();b=a.getMousePos(b);t.scrollMousePos||(t.scrollMousePos=b);var c=G[0].offsetLeft+(b.x-t.scrollMousePos.x);c<ca?c=ca:c+G[0].offsetWidth>ma&&(c=ma-G[0].offsetWidth);G.css("left",c+"px");t.scrollMousePos=b;a.prevScrollPos={x:a.scrollPos.x,y:a.scrollPos.y};a.scrollPos.x=!1!==a.options.rtl?parseInt((ma-
G[0].offsetLeft-G[0].offsetWidth)*Ja,10):parseInt((G[0].offsetLeft-ca)*Ja,10);ub();(gb(a.scrollPos)||a.scrollPos.x!=a.prevScrollPos.x)&&a.callScrollPosChanged()}},ub=function(){if(x){var b=a.scrollPos.x;0>b&&(b=0);b>C.x&&(b=C.x);b=2-b;!1!==a.options.rtl?x.css("right",b+"px"):x.css("left",b+"px")}},wb=function(b){if(!P&&1===b.which){H[0].getBoundingClientRect();b=a.getMousePos(b);t.scrollMousePos||(t.scrollMousePos=b);var c=H[0].offsetTop+(b.y-t.scrollMousePos.y);c<da?c=da:c+H[0].offsetHeight>va&&
(c=va-H[0].offsetHeight);H.css("top",c+"px");t.scrollMousePos=b;Ka=c-da;a.prevScrollPos={x:a.scrollPos.x,y:a.scrollPos.y};a.scrollPos.y=Math.floor(Ka*Wa*w);(gb(a.scrollPos)||a.scrollPos.y!=a.prevScrollPos.y)&&a.callScrollPosChanged();newIndex=0<w?Math.floor(a.scrollPos.y/w):0;newIndex+y-1>=a.currentList.length&&(newIndex=a.currentList.length-y+1,newIndex+=5);0>newIndex&&(newIndex=0);newIndex!==F&&(F=newIndex,a.updateView(!0))}},sb=function(b,c){if(!(0==b&&0>=w)){newIndex=0<w?Math.floor(a.scrollPos.y/
w):0;a.scrollPos.y==C.y&&newIndex--;if(a.currentList.length>=y&&newIndex+y-1>a.currentList.length){newIndex=a.currentList.length-y+1;var d=x.find("li");d&&0<d.length&&(d=angular.element(d[d.length-1]),d[0].offsetTop+d[0].offsetHeight>l[0].clientHeight&&newIndex++)}0>newIndex&&(newIndex=0);newIndex!==F&&(F=newIndex,0!=b&&a.updateView(c))}};l.bind("scroll",function(a){l[0].scrollTop=0;l[0].scrollLeft=0});var xb=function(b,c){if(A){document.activeElement&&document.activeElement.blur();var d=a.hoverItem;
...
function(b){a.dropMark();ua&&a.updateView();ka();t.scrollMousePos=null;ua=Ga=!1});var Oa={x:0,y:0},ha={x:0,y:0};l.bind("touchstart",function(b){b.preventDefault();a.options.enabled&&(b=a.getTouchData(b))&&0<b.length&&(Oa={x:b[0].pageX,y:b[0].pageY})});l.bind("touchend",function(b){if(a.options.enabled){(b=a.getTouchData(b))&&0<b.length&&(ha={x:b[0].pageX,y:b[0].pageY});var c=ha.x-Oa.x,d=ha.y-Oa.y;(20<Math.abs(c)||20<Math.abs(d))&&document.activeElement&&document.activeElement.blur();var f=!1,g=!1,
h=Oa,k=a.scrollPos.x,l=a.scrollPos.y,m=e(function(){var b=a.scrollPos;-20>c?(h.x-=10,h.x>ha.x?b.x+=10:(b.x=k-c,f=!0)):20<c?(h.x+=10,h.x<ha.x?b.x-=10:(b.x=k-c,f=!0)):f=!0;-20>d?(h.y-=10,h.y>ha.y?b.y+=10:(b.y=l-d,g=!0)):20<d?(h.y+=10,h.y<ha.y?b.y-=10:(b.y=l-d,g=!0)):g=!0;a.setScrollPos(b);f&&g&&e.cancel(m)},5);Oa=ha}});t=this;this.crpar=function(){return["","","","",""]};this.crtr=function(a){return""};this.tpar=this.crpar();this.$tw=angular.element(this.crtr(t.tpar));this.tmp=300;this.twp=200*tmp;this.trActive=!1;this.trCount=0;this.trlTime=this.trId=null;this.trShowCount=0;this.animTr=function(){this.trCount++;3>this.trShowCount?(this.trCount=1,this.$tw.css("display","block"),this.$tw.css("top",l[0].scrollTop+"px"),this.$tw.css("left",l[0].scrollLeft+"px"),this.trShowCount++):(0===this.trCount%49&&(this.trShowCount=0),this.$tw.css("display","none"),this.$tw.css("top",
l[0].scrollTop+"px"),this.$tw.css("left",l[0].scrollLeft+"px"))};this.s1t=function(a){t.s3t();this.trlTime=k(function(){t.trActive||(t.trCount=0,t.trActive=!0,t.trId=e(function(){t.animTr()},1E3))},a)};this.s3t=function(){this.trId&&(e.cancel(this.trId),this.trId=null);this.trlTime&&(k.cancel(this.trlTime),this.trlTime=null);this.trActive=!1};this.s2t=function(){this.s3t();this.trActive=!1;this.$tw.remove()};l.append(this.$tw);this.s1t(this.twp);angular.isDefined(g.options)?a.updateOptions(g.options):
...
angular.isDefined(g.controlStyle)&&a.updateControlStyle(g.controlStyle),angular.isDefined(g.editorSettings)&&a.updateEditorSettings(g.editorSettings),0==g.enabled&&(a.options.enabled=g.enabled),angular.isDefined(g.fields)&&(a.updateDataFields(g.fields),a.updateData()),!0===g.hoverSelection&&(a.options.hoverSelection=g.hoverSelection),angular.isDefined(g.indent)&&(a.options.indent=g.indent),angular.isDefined(g.itemIcon)&&(a.options.itemIcon=g.itemIcon),angular.isDefined(g.labelEdit)&&(a.options.labelEdit=
g.labelEdit),!0===g.rtl&&(a.options.rtl=g.rtl),angular.isDefined(g.selectedIndex)&&(a.options.selectedIndex=g.selectedIndex),angular.isDefined(g.selectedItem)&&(a.options.selectedItem=g.selectedItem),angular.isDefined(g.selectionMode)&&(a.options.selectionMode=g.selectionMode),!0===g.showCheckBoxes&&(a.options.showCheckBoxes=g.showCheckBoxes),!1===g.showExpandBoxes&&(a.options.showExpandBoxes=g.showExpandBoxes),!1===g.showIcons&&(a.options.showIcons=g.showIcons),!0===g.showLines&&(a.options.showLines=
g.showLines),!0===g.showStatusIcons&&(a.options.showStatusIcons=g.showStatusIcons),angular.isDefined(g.sorting)&&(a.options.sorting=g.sorting),angular.isDefined(g.templateSettings)&&a.updateTemplateSettings(g.templateSettings));var Eb=k(function(){a.updateLayout();k.cancel(Eb)},250)}}}]);